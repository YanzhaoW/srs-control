...
Default configuration can be generated by

```bash
srs-control --dump-config default-config.yml
```

 Configurations with their default values are listed in the YAML file:
