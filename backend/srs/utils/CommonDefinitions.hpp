...
namespace srs::common
{
    ...
    constexpr auto SRS_TIMESTAMP_HIGH_BIT_LENGTH = 32U;
    constexpr auto SRS_TIMESTAMP_LOW_BIT_LENGTH = 10U;
    ...
    constexpr auto file_max_size = 1048576 * 10; //!< file size limited to 10 MB.
